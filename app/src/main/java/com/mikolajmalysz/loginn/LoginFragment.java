...
// profile. ID and basic profile are included in DEFAULT_SIGN_IN.
        ...
        v.findViewById(R.id.sign_in_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getContext(), "Please wait a second...", LENGTH_SHORT).show();
                signIn();
            }
        });
    ...
    public void onStart() {
        ...
        if (currentUser != null){
            ...
            Log.i("onStart", "no one is logged in");
        }
    }
    ...
    private void signIn() {
        Log.i("signIn", "called");
        Toast.makeText(getContext(), "signIn, called", LENGTH_SHORT).show();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Toast.makeText(getContext(), "onActivityResult, started", LENGTH_SHORT).show();
...
//            updateUI(account);
            Toast.makeText(getContext(), "handleSignInResult: success", LENGTH_SHORT).show();
        } catch (ApiException e) {
            // The ApiException status code indicates the detailed failure reason.
            // Please refer to the GoogleSignInStatusCodes class reference for more information.
            Log.w("handleSignInResult", "signInResult:failed code=" + e.getStatusCode());
            Toast.makeText(getContext(), "handleSignInResult" + e.getStatusCode(), LENGTH_SHORT).show();
//            updateUI(null);
        }
    }
                ...
                .addOnCompleteListener(getActivity(), new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(getContext(), "Firebase auth with google: success", LENGTH_SHORT).show();
                            FirebaseUser user = mAuth.getCurrentUser();
                            home();
                        } else {
                            // If sign in fails, display a message to the user.
                            Log.w("firebaseAuthWithGoogle", "signInWithCredential:failure", task.getException());
                            Toast.makeText(getContext(), "Firebase auth with google: failure", LENGTH_SHORT).show();
//
                        }
